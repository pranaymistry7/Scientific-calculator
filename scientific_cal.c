...
#define note "Enter the valid operation U math dumb"
void addition();
void subraction();
void multiplication();
void division();
...
void square(){
    ...
    scanf("%lf",&b);
    double p=pow(b,2);
    printf("The square of %.2lf is %.2lf",b,p);
}
void cube(){
    double b;
    ...
    scanf("%lf",&b);
    double p=pow(b,3);
    printf("The cube of %.2lf is %.2lf",b,p);
}
void squareroot(){
    double b;
    ...
    scanf("%lf",&b);
    double s = sqrt(b);
    printf("The square root of %.2lf is %.2lf",b,s);
}